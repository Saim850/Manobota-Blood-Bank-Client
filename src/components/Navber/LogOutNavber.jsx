      ...
      <div className="navbar bg-base-100 shadow-sm">
        ...
        <div className="navbar-end">
            <div className="dropdown dropdown-end">
                <button className="bg-red-500 text-white font-bold p-2 rounded-md mr-3"><Link to="/login">Login</Link></button>
                <button className="bg-red-500 text-white font-bold p-2 rounded-md mr-3"><Link to="/register">Register</Link></button>
            </div>
        </div>
      </div>
    </>
